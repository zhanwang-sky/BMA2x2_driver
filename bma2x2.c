...
u8 *data_u8, u32 len_u32)
{
	...
	BMA2x2_RETURN_FUNCTION_TYPE com_rslt = E_BMA2x2_INITIAL_CODE;
...
BMA2x2_RETURN_FUNCTION_TYPE bma2x2_set_range(u8 range_u8)
{
	...
	if (p_bma2x2 == BMA2x2_NULL) {
		...
		com_rslt = E_BMA2x2_OUT_OF_RANGE;
		}
	}
	return com_rslt;
}
...
{
	BMA2x2_RETURN_FUNCTION_TYPE com_rslt = C_BMA2x2_SUCCESS;
